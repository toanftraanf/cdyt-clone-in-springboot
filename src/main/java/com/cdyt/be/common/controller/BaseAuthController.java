...
public abstract class BaseAuthController {
    ...
    /**
     * Current authenticated user (equivalent to userToken in .NET)
     */
    protected User currentUser;

    /**
     * Authentication result (equivalent to ResultCheckToken in .NET)
     */
     ...
     * metadata
     */
    protected <T> ResponseEntity<ApiResponse<T>> ok(T data, String message, Map<String, Object> additionalMetadata) {
    ...
    protected <T> ResponseEntity<ApiResponse<T>> created(T data, String message,
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(ResponseUtils.created(data, message, additionalMetadata));
    }
    ...
    /**
     * Authentication result class (equivalent to Result in .NET)
     */
    @Getter
    @Setter
